...
namespace VirtualL
{
    public partial class FinalTest2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // sqlconn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["OCAConnectionString"].ToString() );
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            int i = rnd.Next(20, 40);//Here specify your starting slno of question table and ending no.
        ...
        {
            if (Convert.ToInt32(Session["counter"].ToString()) < 30)//20 is a counter which is used for 10 questions
            {
        ...
        protected void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (time == examtime)
            {
                ...
                Label3.Visible = true;
                Label3.Text = "Your Second Session is Completed";
                // lblScore.Visible = true;
                Button3.Visible = true;
                Button3.Enabled = true;
                Session.Add("test2score", lblScore.Text.ToString());
            }
        }
