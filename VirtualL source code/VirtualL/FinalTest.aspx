<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalTest.aspx.cs" Inherits="VirtualL.FinalTest" %>
...
<body>
    ...
    <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="DarkRed" Style="z-index: 100;
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#E0E0E0" BorderColor="#E0E0E0" Height="264px"
            ...
            top: 24px; right: 307px;" Text="Name : " ForeColor="#0000C0" Width="387px"></asp:Label>
            &nbsp;
          ...
          <span id="cd" style ="left:100px;"></span>
            ...
            top: 178px" Text="Next" ToolTip="Click Here to Take Next Question" 
                    OnClick="Button2_Click" UseSubmitBehavior="False" />

                        
            </asp:Panel>
            
            <asp:Label ID="Label3" runat="server" Text="Label" Visible="false" ForeColor="Red" Font-Bold="True"></asp:Label>
             </asp:Panel>
